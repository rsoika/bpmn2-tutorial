...
public class ItemImpl extends MinimalEObjectImpl.Container implements Item {
	/**
	 * The cached value of the '{@link #getValuelist() <em>Valuelist</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getValuelist()
	 * @generated
	 * @ordered
	 */
	protected EList<Value> valuelist;
	 ...
	 * @generated
	 */
	public EList<Value> getValuelist() {
		if (valuelist == null) {
			valuelist = new EObjectContainmentEList<Value>(Value.class, this, ModelPackage.ITEM__VALUELIST);
		}
		return valuelist;
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ITEM__TYPE, oldType, type));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.ITEM__VALUELIST:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.ITEM__VALUELIST:
				getValuelist().clear();
				getValuelist().addAll((Collection<? extends Value>)newValue);
				return;
			case ModelPackage.ITEM__NAME:
